module element_holder(){
    translate([-0.5,-0.1,0])color("red")cube([1,3,8]);
    
    translate([-4.5,2,2])rotate(a=90, v=[0,1,0])
    color("red")cylinder(h=9, r =0.5);
    
    translate([-4.5,2,5])rotate(a=90, v=[0,1,0])
    color("red")cylinder(h=9, r =0.5);
    
    translate([-21,11.5,0.5])color("red")cube([42,0.5,8]);
    
    translate([-17.5,7,1])rotate(a=90, v=[-1,0,0])
    color("red")cylinder(h=9, r =0.5);
     translate([-17.5,7,6])rotate(a=90, v=[-1,0,0])
    color("red")cylinder(h=9, r =0.5);
